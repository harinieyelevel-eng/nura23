...
const Services = () => {
  return (
    <div className="min-h-screen pt-16">
      <SEO
        title="Skin, Hair, Aesthetic & Wellness Treatments in Chennai | NURA23 Clinic"
        description="Explore NURA23 services in Chennai, including acne and skin treatments, laser skin treatment, anti-aging solutions, skin lightening treatment, body slimming treatments, weight loss programs, foot reflexology massage and holistic wellness therapies under one roof."
      />
      {/* Services Grid */}
